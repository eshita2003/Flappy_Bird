...
class Game:
    def __init__(self):
        ...
        self.restert_text_rect=self.restart_text.get_rect(center=(300,700))
        ...
        while True:
            ...
            for event in pg.event.get():
                ...
                if event.type==pg.MOUSEBUTTONDOWN:
                    if self.restert_text_rect.collidepoint(pg.mouse.get_pos()):
                        self.restartGame()
    ...
    def drawEverything(self):
        ...
        if not self.is_game_started:
            self.win.blit(self.restart_text,self.restert_text_rect)
